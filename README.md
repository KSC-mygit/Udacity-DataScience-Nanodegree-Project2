...
I used <a href='https://scikit-learn.org/stable/modules/generated/sklearn.multioutput.MultiOutputClassifier.html'> sklearn.multioutput.MultiOutputClassifier</a> to train and fit the model and used xgboost as the estimator for the classifier. I considered KNeighborsClassifier and RandomForestClassifier as alternative options for the classifier's estimate but ultimately settled on xgboost based on the accuracy and efficiency relative to the 2 alternatives that I explored and tested.
